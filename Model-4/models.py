...
class DeepCNN():
    ...
    def simple_model(self, input_shape=(28, 28, 3), op="sgd"):
        cnn = Sequential()

        cnn.add(Conv2D(32, (3, 3), activation='relu', input_shape=[28, 28,
                                                                   3]))
    ...
    def model_batch(self, input_shape=(28, 28), op="sgd"):
        cnn = Sequential()
    ...
    def regulizer_model(self, input_shape=(28,28,3), op="sgd", regularizers_sterength=0.01):
        cnn = Sequential()
